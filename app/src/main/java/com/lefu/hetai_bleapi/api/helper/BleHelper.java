...
public class BleHelper {
    ...
    public  Records parseDLScaleMeaage( String readMessage,float height,int sex,int age,int level) {
        ...
        try {
            ...
            Log.e(TAG, "weight==> ："+weight+"  height:"+height+"  sex:"+sex+"  age:"+age+"  level:"+level+"  impedance:"+impedance);

            Log.e(TAG, "Body fat==>" + bodyfat.getBodyfatParameters()+"====impedance++>"+impedance);
            ...
            if(bodyfat.getBodyfatParameters() == HTDataType.ErrorNone){
                ...
                Log.e(TAG, "阻抗:" + bodyfat.ZTwoLegs +
                        ...
                        "  boneKg:" + String.format("%.1fkg",bodyfat.boneKg) +
                        "  body fat:" +String.format("%.1f%%",bodyfat.bodyfatPercentage) +
                        "  waterPercentage:" + String.format("%.1f%%",bodyfat.waterPercentage) +
                        "  muscleKg:" + String.format("%.1fkg",bodyfat.muscleKg) + "\r\n");
            }else {
    ...
    public Records parseScaleData(String readMessage,double height,int sex,int age,int level){
        ...
        if(bodyfat.getBodyfatParameters() == HTDataType.ErrorNone){
            ...
            Log.i("记录", "阻抗:" + bodyfat.ZTwoLegs +
                    "Ω  BMI:" + String.format("%.1f",bodyfat.BMI) +
                    "  BMR:" + (int) bodyfat.BMR +
                    "  bodyfat:" + (int) bodyfat.VFAL +
                    "  boneKg:" + String.format("%.1fkg",bodyfat.boneKg) +
                    "  bodyfatPercentage:" +String.format("%.1f%%",bodyfat.bodyfatPercentage) +
                    "  waterPercentage:" + String.format("%.1f%%",bodyfat.waterPercentage) +
                    "  muscleKg:" + String.format("%.1fkg",bodyfat.muscleKg) + "\r\n");
        }else {
